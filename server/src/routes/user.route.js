...
const { registerUser, logIn, getAllUser, logOut, updatePassword, updateAvatar, updateAccountDetails, searchUsers, refreshAccessToken} = require("../controllers/user.controller.js");
